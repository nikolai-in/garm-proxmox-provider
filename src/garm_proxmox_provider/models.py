...
class BootstrapInstance:
    ...
    def from_dict(cls, data: dict[str, Any]) -> BootstrapInstance:
        ...
        return cls(
            ...
            metadata_url=data.get("metadata-url", data.get("metadata_url", "")),
            callback_url=data.get("callback-url", data.get("callback_url", "")),
            instance_token=data.get("instance-token", data.get("instance_token", "")),
